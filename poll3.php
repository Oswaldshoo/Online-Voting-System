...
<div class="container">
  ...
  <div class="row">
    <div class="column">
      <img src="images/tatu.jpg" style="width:100%">
    </div>
    <div class="column">
    <center>  <form  method="POST" action="count.php">
      <?php
              $query = mysqli_query($con,"SELECT * FROM `candidate` WHERE `position` = 'President' && `value` = '3'") or die(mysqli_errno());
       ...
       <br>
        ...
        <br>
        <br>
        <input type="submit" name value="Submit Your Vote">
      </form>
      </center>
    </div>
  </div>
